...
<%--                                    &lt;%&ndash;                                                                <button type="submit" name="action" value="signUp" class="btn btn-secondary" data-dismiss="modal">Sign Up</button>&ndash;%&gt;--%>
<%--                                </div>--%>
...
<div class="background">
  <div class="caption">
    <h1 style="color: #F8F8FF">WELCOME TO SUPPLEMENT SHOP</h1>
  </div>
  <div align="center">
    <form action="/home">
      <input type="submit" class="btn btn-outline-warning" value="LET'S GO">
    </form>
  </div>
  <div class="copyright"><p>@Product by Tuan Anh Nguyen - 2020 ©</p></div>
</div>
</body>
<style>
  body, html {
